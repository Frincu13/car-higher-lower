...
Fiecare criteriu are o scală scurtă, scrisă în `CRIT` din `data/samsar.js`: ce înseamnă un 10, un 5 și un 1. Scalele intră în instrucțiune, ca agentul să dea același 8 de fiecare dată, dar sunt și pe ecran: un buton lângă lista de criterii deschide un panou care le arată pe toate, plus scara de price fit calculată pe bugetul clientului din rundă. Fără el nu ai de unde să știi ce înseamnă un 10 la confort pe drum lung.
