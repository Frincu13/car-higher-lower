  ...
  const TXT = {
    ro: {
      ...
      pasi: [
        ...
        'Ce scrie în anunț, e acolo. Ce nu scrie dar reiese sigur din versiunea din titlu, tot acolo e: xDrive, quattro, 4Motion și Allrad înseamnă tracțiune integrală, Touring, Combi și Avant înseamnă break, DSG și Automatik înseamnă cutie automată, 320d înseamnă doi litri diesel.',
        'Ce nu scrie în anunț și e doar o opțiune pe care modelul o putea avea, nu presupui că e acolo. Dai o notă mică și spui în motiv că anunțul nu o menționează. Nu cauți pe internet ce echipări existau la modelul ăla.',
      ],
    ...
    en: {
      ...
      pasi: [
        ...
        'What the listing says is there. What it does not say but the version name guarantees is also there: xDrive, quattro, 4Motion and Allrad mean all-wheel drive, Touring, Combi and Avant mean an estate, DSG and Automatik mean an automatic gearbox, 320d means a two litre diesel.',
        'What the listing does not say and is only an option the model could have had, you do not assume. Give a low score and say in the reason that the listing does not mention it. Do not go looking up which trims offered what.',
      ],
