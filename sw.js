...
const FILES = [
  ...
  'styles.css', 'i18n.js', 'shared.js', 'kinds.js', 'grades.js', 'data/cars.js',
  'app.js', 'draft.js', 'turometru.js', 'ordine.js', 'garaj.js', 'licitatie.js',
  'favicon.svg', 'manifest.webmanifest', 'img/frq-logo.png',
  'img/icon-192.png', 'img/icon-512.png',
  'img/hub-sus-sau-jos.webp', 'img/hub-masina-perfecta.webp', 'img/hub-turometru.webp',
  'img/hub-ordine.webp', 'img/hub-garaj.webp', 'img/hub-licitatie.webp',
];
