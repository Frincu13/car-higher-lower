...
window.I18n = (() => {
  ...
  const EN = {
    ...
    'samsar': 'dealer',
    'Un client cu poveste și un buget. Fiecare aduce un anunț real, iar un agent AI dă notele.':
      'A client with a story and a budget. Each of you brings a real listing, and an AI agent does the scoring.',
    'Jocuri': 'Games',
    ...
    '24 de clienți, 10 categorii': '24 clients, 10 categories',
    'Un rând de mașini aliniate într-un parc auto': 'A row of cars lined up on a dealer lot',
    'Rundă pentru': 'Round for',
    'Mod de joc': 'Game mode',
    'Client cu poveste': 'Client with a story',
    'Un om, un buget, șase criterii ale lui': 'One person, one budget, their own six criteria',
    'Cea mai bună din clasă, fără client': 'Best in class, no client',
    'Mix': 'Mix',
    'Tras la sorți, uneori cu o regulă în plus': 'Drawn at random, sometimes with an extra rule',
    'Clientul rundei': 'Client of the round',
    'Categoria rundei': 'Category of the round',
    'Pe ce se dau notele': 'What the scores are for',
    'Buget': 'Budget',
    'Regulă': 'Rule',
    'Cele două surprize': 'The two surprises',
    'Se dezvăluie abia în tabel. Până atunci sunt codate: fiecare literă e mutată cu trei în față.':
      'They are revealed only in the table. Until then they are encoded: every letter moved three places forward.',
    ...
    'Copiază': 'Copy',
    'Selectat, copiază': 'Selected, copy it',
    ...
    'nota categoriei': 'category score',
  ...
  const RX = [
    ...
    [/^Agentul a decodat altfel: a scris (.+) în loc de (.+)\. Notele de la surpriza aia sunt de luat cu rezervă\.$/,
      'The agent decoded it differently: it wrote $1 instead of $2. Take that surprise score with a pinch of salt.'],
